...
const {logout,user}=useAuth()
  ...
  const NavLinks = <>
        <li className='border-r-2 px-2 '><Link 
        className='hover:border-b-2 ' to="/">Home</Link></li>
        {/* <li><Link to="/login">login</Link></li>
        <li><Link to="/regi">signup</Link></li> */}
     {
      user?    <li className='border-r-2 px-2'><Link className='hover:border-b-2' to="/dashboard">Dashboard</Link></li>
   ...
   <li className='border-r-2 px-2'><Link className='hover:border-b-2' to="/allproperties">All Properties</Link></li>
...

        {
            user ? <>
                ...
                <li className='border-r-2 px-2'>  <Link className='hover:border-b-2' onClick={handleLogOut} >LogOut</Link></li>
            </> : <>
                <li className='border-r-2 px-2'><Link className='hover:border-b-2' to="/login">Login</Link></li>
            </>
        }
  ...
  return (
    ...
    <div className='flex h-10 lg:h-16   fixed z-50 
    top-0 
     w-full first-letter first-lette 
      first-letter bg-[#d9ccb5] bg-opacity-50 backdrop-blur-md 
      text-white justify-between lg:px-24 align-middle
       items-center '>
    <div >
   
    <a className="  hidden  normal-case lg:flex gap-2 justify-center  px-6 align-middle items-center lg:text-2xl text-2xl  md:text-4xl bg-white text-black">
            ...
            <div className="dropdown">
                ...
                <ul tabIndex={0} className="menu
                 bg-blue-200 menu-compact dropdown-content mt-3 p-2 shadow text-gray-600 font-bold rounded-box w-52">
